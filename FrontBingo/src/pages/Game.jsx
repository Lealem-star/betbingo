                    ...
                    <div className="app-header">
                        <div className="app-logo">
                            <div className="logo-circle">
                                <img src={lbLogo} alt="Bet Bingo Logo" className="logo-image" />
                            </div>
                            <span className="app-title" style={{ color: '#facc15' }}>Bet Bingo</span>
                        </div>
                                            ...
                                            {adminPost.kind === 'image' ? (
                                                ...
                                                <video
                                                    ...
                                                    onError={(e) => {
                                                        ...
                                                        fallbackImg.alt = 'Bet Bingo Logo';
